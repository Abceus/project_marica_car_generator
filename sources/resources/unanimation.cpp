...
std::ostream& operator<<(std::ostream& stream, VJointPos o) {
    stream << "Orientation: " << o.Orientation << std::endl
           << "Postition: " << o.Position;
    return stream;
}
...
std::ostream& operator<<(std::ostream& stream, VQuat o) {
...
VPoint::VPoint(float vX, float vY, float vZ) : X(vX), Y(vY), Z(vZ) {}

std::ostream& operator<<(std::ostream& stream, VPoint o) {
